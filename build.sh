...
# 添加 Anykernel3
rm -rf AnyKernel3
git clone --depth=1 https://github.com/wyh757787026/AnyKernel3.git
...
# 编译完成后内核名字
FINAL_KERNEL_ZIP=AnyKernel3-cmi-${current_time}.zip

# 内核工作目录
export KERNEL_DIR=$(pwd)

# 内核 defconfig 文件
export KERNEL_DEFCONFIG=vendor/cmi_defconfig

# 编译临时目录，避免污染根目录
export OUT=out

# clang 和 gcc 绝对路径
export CLANG_PATH=/mnt/tools/clang
export PATH=${CLANG_PATH}/bin:${PATH}
export GCC64_PATH=/mnt/tools/gcc64
export GCC32_PATH=/mnt/tools/gcc32
...
# 复制打包好的 Zip 文件到指定的目录
cp $ANYKERNEL3_DIR/$FINAL_KERNEL_ZIP /mnt/out/
...
# 要发送的消息内容
MESSAGE="cmi Kernel build successfully!"
